...
<h2 id="payments">Payments, cancellations and refunds</h2><p>Paid-course registrations use fee challans, payment-stage tracking and manual payment verification. Check the selected course's current price and Admissions instructions before paying.</p>
<p>Course fees are not refundable once a registration is confirmed and the payment is verified. Confirm the course schedule, format and fee with Admissions before you pay, because the fee is not returned afterwards. If EchoLens cancels a course or does not deliver it, you may transfer to another cohort or to a course of equivalent value; where no suitable alternative is available, Finance resolves the matter with you directly. A duplicate or incorrect payment made in error is returned once it is verified against the challan record. Free courses involve no payment, so no refund applies to them. Send refund or payment questions to <a href="mailto:finance@echolens.digital">finance@echolens.digital</a>.</p>
...
<h2>Limitation of liability</h2><p>EchoLens's liability is limited to the extent permitted by the law of Pakistan. Nothing in these terms excludes or limits liability that cannot lawfully be excluded or limited. Subject to that, EchoLens is not liable for indirect or consequential loss arising from use of the platform.</p>
<h2>Suspension and termination</h2><p>The app supports account-status changes, moderation, enrollment removal and automatic expiry of incomplete free-course enrollments. Access can be restricted for misuse or unauthorized activity. Removal of access does not itself erase all historical records. Access can end in the ways the platform actually supports: an administrator changes your account status or removes the account, staff moderate or remove published content, an enrollment is removed with a recorded reason, or an incomplete free-course enrollment reaches the end of its three-calendar-month window and expires automatically. Expiry and removal preserve submitted work, grades and certificates; they do not erase historical records.</p>
<p>To appeal any of these, raise it through <a href="/contact">Contact &amp; Support</a> or email ${contact}, identifying the account and what you are appealing. An administrator can restore an expired free-course enrollment, which starts a fresh three-month window. These terms do not set a fixed notice period or appeal deadline.</p>
