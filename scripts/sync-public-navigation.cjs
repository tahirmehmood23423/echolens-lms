...
const pages = ['landing','open','compiler','login','reset-password','registration-status','cert','challan','recruiter-signup','showcase','showcase-post','talent-search','talent-profile','talent-project','talent-projects','talent-interest','profile'];
