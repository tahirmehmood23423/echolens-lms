...
The published inventory contains **10 courses, 47 modules, 142 lessons and 142 assignments**. Six additional Trending Tech tracks are staged with 24 modules, 72 lectures, 72 assignments and 6 capstones. They appear in Free Certified Courses as **Coming Soon** syllabus previews while enrollment, lessons and submissions remain locked until all 72 required EchoLens video URLs are ready. The original **131 unique videos all reported AVAILABLE**. Standard embeds demonstrated playback for **107**, with **24 UNVERIFIED** in the short probe. The app's actual privacy-enhanced embed demonstrated playback for **128**, with **3 UNVERIFIED**. These are separate observations; a timeout is not proof of a broken link.
